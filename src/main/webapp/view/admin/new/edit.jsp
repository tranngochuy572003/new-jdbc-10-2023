...
<c:url var="APIurl" value="/api-admin-new"/>
    //goi /admin-new khong no khong work nen phai tao newUrl
...
<script>
    ...
    $('#btnAddOrUpdateNew').click(function (e) {
        ...
        var data = {};
        //khai bao name trong moi field , get tat ca gia tri trong moi name co value tuong ung
    ...
    //ajax( gui api de thang api mapping  doget/dopost nhan duoc)
    function addNew(data) {
        $.ajax({
            url: '${APIurl}',
            type: 'POST',
            //contentType: kieu du lieu client gui ve cho server
            contentType: 'application/json',
            //data hien tai dang la javascript object va chuyen sang json vi thang server chi nhan json
